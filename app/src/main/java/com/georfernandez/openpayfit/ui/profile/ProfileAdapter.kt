...
import com.georfernandez.openpayfit.databinding.FragmentProfileCardBinding
...
class ProfileAdapter(private val movieStarringList: List<MovieStarring>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfileViewHolder {
        ...
        val binding = FragmentProfileCardBinding.inflate(inflater, parent, false)
...
class ProfileViewHolder(private val binding: FragmentProfileCardBinding) : RecyclerView.ViewHolder(binding.root) {
